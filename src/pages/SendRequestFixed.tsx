            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-4 py-3 text-gray-800 bg-gray-50 border-2 border-gray-300 rounded-lg text-lg focus:outline-none focus:border-blue-500 focus:bg-white transition-all resize-none"
                  style={{ color: "#1f2937", backgroundColor: "#f9fafb" }}
                />
              </div>
