...
const SendRequest = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      setCategories([
        { id: 1, name: "Programming", description: "Software development", icon: "code" },
        { id: 2, name: "Design", description: "UI/UX design", icon: "palette" },
        { id: 3, name: "Mathematics", description: "Math problems", icon: "calculator" },
        { id: 4, name: "Languages", description: "Language learning", icon: "globe" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-center">Post a Help Request</CardTitle>
